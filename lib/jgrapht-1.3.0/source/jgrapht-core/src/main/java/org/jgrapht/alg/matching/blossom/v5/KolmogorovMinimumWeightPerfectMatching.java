 ...
 * <p>
 * The algorithm can be divided into two phases: initialization and the com algorithm. The
 * initialization phase is responsible for converting the specified graph into the form convenient
 * for the algorithm and for finding an initial matching to speed up the com part. Furthermore, the
 * com part of the algorithm can be further divided into primal and dual updates. The primal phases
 ...
 * computation are performed lazily and don't affect the running time of the com algorithm. If the
    ...
    MatchingAlgorithm<V, E>
{
    ...
    /**
     * Finishes the algorithm after all nodes are matched. The com problem it solves is that the
     ...
     * of performed dual operations during the com phase of the algorithm
     */
