...
class SchedulerTest1 {
    ...
    void setUp() {
        ...
        scheduler.getCarMap().get(200).setState(CarState.WAIT).setCurrentSpeed(5).setLaneId(2).setStartTime(1).setPosition(10).addPath(1).addPath(2);
