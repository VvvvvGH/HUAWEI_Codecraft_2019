...
class SchedulerTest3 {
    ...
    void setUp() {
        ...
        scheduler.addCar(new Car(200, 11, 13, 1, 1));
        scheduler.addCar(new Car(300, 11, 13, 1, 1));
        scheduler.addCar(new Car(101, 11, 13, 1, 1));
        ...
        scheduler.getCarMap().get(200).setState(CarState.WAIT).setCurrentSpeed(1).setLaneId(2).setStartTime(1).setPosition(10).addPath(1).addPath(2);
        scheduler.getCarMap().get(300).setState(CarState.WAIT).setCurrentSpeed(1).setLaneId(3).setStartTime(1).setPosition(10).addPath(1).addPath(2);
        scheduler.getCarMap().get(101).setState(CarState.WAIT).setCurrentSpeed(1).setLaneId(1).setStartTime(1).setPosition(9).addPath(1).addPath(2);
    ...
    void step() {
        ...
        assertAll("Car position",
                ...
                () -> assertEquals(2,scheduler.getCar(300).getLaneId()),
                ...
                () -> assertEquals(3,scheduler.getCar(201).getLaneId()),
